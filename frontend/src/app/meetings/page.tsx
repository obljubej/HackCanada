                ...
                {completed.map(m => (
                  <div key={m.id} className="bg-card border border-border rounded-2xl p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4 transition-colors">
                     <div className="space-y-2.5">
                      ...
                      <Link href={`/meetings/${m.id}/summary`} className="hover:bg-accent text-accent-foreground font-semibold text-sm px-6 py-2.5 rounded-xl transition-colors flex items-center gap-2 shrink-0 border border-border">
