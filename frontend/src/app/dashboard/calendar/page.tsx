                ...
                {cells.map((day, i) => {
                  ...
                  return (
                    <div
                      ...
                      className={`h-14 sm:h-16 rounded-lg p-1.5 cursor-pointer transition-colors ${
                        isSelected
                          ? "bg-primary/30 ring-2 ring-primary"
                          : isToday
                          ? "bg-primary/20 ring-1 ring-primary/40 hover:bg-primary/25"
                          : "hover:bg-muted/50"
                      }`}
                    >
                      <div className={`text-xs font-semibold w-6 h-6 flex items-center justify-center rounded-full ${
                        isToday && !isSelected ? "bg-primary text-primary-foreground" : "text-muted-foreground"
                      }`}>
                        {day}
                      </div>
